...
export default function FoodCouponPage() {
  ...
  const couponBookingsOpen =
    process.env.NEXT_PUBLIC_COUPON_BOOKINGS_OPEN === "true";
        ...
        {couponBookingsOpen ? (
          <>
            <p
              ...
              style={{ fontFamily: "'Alumni Sans Pinstripe', cursive" }}
            >
              Select the number of (Lunch + Snack) coupons you’d like to
              purchase.
            </p>
            ...
            >
              <p>
                <strong>Note:</strong> Each quantity includes <em>one Lunch</em>{" "}
                and <em>one Snack</em>, and will appear as separate entries in
                your &rsquo;My orders&rsquo; section post payment.
              </p>
              <p>
          ...
          <p
            className="text-center text-2xl sm:text-4xl mt-24 text-gray-100"
            style={{ fontFamily: "'Alumni Sans Pinstripe', cursive" }}
          >
            New Food coupon purchase is currently closed.<br />
            Please buy your coupon directly at the food counter.<br /><br />
            If you already have coupons in your name, find them in the &rsquo;My orders&rsquo; section from menu. 
          </p>
        )}
      </div>
    </div>
